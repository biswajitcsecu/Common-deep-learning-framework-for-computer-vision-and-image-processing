...
BATCH_SIZE = 32
TRAIN_VAL_IMAGE_DIR = "Brighten/train/low"
TEST_IMAGE_DIR = "Brighten/test/low"
LEARNING_RATE = 1e-4
LOG_INTERVALS = 10
EPOCHS = 10
...
#model defination
def build_cnn_net(image_size=None) -> keras.Model:
...
def plot_results(images, titles, figure_size=(10, 10)):
    ...
    def on_epoch_end(self, epoch, logs=None):
        if epoch % self.log_interval == 0: 
            for image_file in self.image_files:
                ...
                plot_results([original_image, enhanced_image],["Original", "Enhanced_Image"],(12, 8),)
...
for image_file in test_image_files:
    ...
    plot_results([original_image, ImageOps.autocontrast(original_image),
                  enhanced_image],["Original", "PIL Autocontrast", "Enhanced_Image"],(15, 10),)
...
for image_file in images:
    ...
    plot_results(
        ...
        ["Original", "PIL Autocontrast", "Enhanced"],(20, 20),)
