...
train_path = 'Osteoarth/train'
valid_path = 'Osteoarth/valid'
test_path = 'Osteoarth/test'
...
cm_plot_labels = ['Normal', 'Osteoarthritis'] 
...
img_path = 'Osteoarth/data/ost25.png'
Image(filename=img_path, width=W,height=H) 
