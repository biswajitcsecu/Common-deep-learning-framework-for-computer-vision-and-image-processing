...
X_train, y_train = images[:1600], masks[:1600]
X_valid, y_valid = images[1600:], masks[1600:]
...
ASPP = UpSampling2D(size=(IMAGE_SIZE//4//ASPP.shape[1], IMAGE_SIZE//4//ASPP.shape[2]),
